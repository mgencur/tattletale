...
/**
 * Reports all packages in the project.
 * @author Martin Gencur
 */
public class PackageReport extends CLSReport
{
   /** NAME */
   private static final String NAME = "Package list";

   /** DIRECTORY */
   private static final String DIRECTORY = "packagelist";
   ...
   public void writeHtmlBodyContent(BufferedWriter bw) throws IOException
   {
      ...
      while (rit.hasNext())
      {
         ...
         if (pack.contains("org.infinispan")) {
            if (odd)
            {
